...
LOCAL_BLOCKCHAIN_ENVIRONMENTS = ["hardhat", "ganache", "development"]
NON_FORKED_LOCAL_BLOCKCHAINS = ["mainnet-fork-devs"]
...
def get_account(index=None, id=None):
    ...
    if (
        ...
        or 
        network.show_active() in NON_FORKED_LOCAL_BLOCKCHAINS
    ):
        return accounts[0]
    if id:
...
def get_contract(contract_name):
    ...
    if network.show_active() in LOCAL_BLOCKCHAIN_ENVIRONMENTS:
        ...
        # Contracy.from_abi[NAME, ADDRESS, ABI]
